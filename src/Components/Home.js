    ...
    return(
      <div className="p-5 container" >
        ...
        <div className="d-flex justify-content-center mt-4">
          <Button id="btn" className="w-15" variant='contained' component='label'>Choose file
        ...
        <div className="d-flex justify-content-center mt-4">
          <Button id="btn" className="w-15" variant='contained' component='label' onClick={handleClick}>Submit</Button>
        </div>
